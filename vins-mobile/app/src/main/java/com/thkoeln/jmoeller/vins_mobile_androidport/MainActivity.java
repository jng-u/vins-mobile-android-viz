...
//    private final int aeCompensation = -1;
    ...
    private void initViews() {
        ...
        final Button vizBtn = (Button) findViewById(R.id.viz_layout_btn);
        vizBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                FragmentTransaction fragmentTransaction = getSupportFragmentManager().beginTransaction();
                Fragment vizFrag = new VizActivity();
                fragmentTransaction.replace(R.id.fragment_container_view, vizFrag);
                fragmentTransaction.addToBackStack(null);
                fragmentTransaction.commit();
                vizBtn.setVisibility(View.INVISIBLE);
            }
        });
    }
    ...
    public void onBackPressed() {
        findViewById(R.id.viz_layout_btn).setVisibility(View.VISIBLE);
        super.onBackPressed();
    }
